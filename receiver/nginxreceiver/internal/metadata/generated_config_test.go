		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					NginxHTTPStatus:          MetricConfig{Enabled: true},
					NginxRequests:            MetricConfig{Enabled: true},
					NginxUpstreamsResponse:   MetricConfig{Enabled: true},
				},
			},
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					NginxHTTPStatus:          MetricConfig{Enabled: false},
					NginxRequests:            MetricConfig{Enabled: false},
					NginxUpstreamsResponse:   MetricConfig{Enabled: false},
				},
			},
		},
	}
